...
func NewWithConfigFile(configFilePath string, opts ...Option) (Apollo, error) {
...
func New(configServerURL, appID string, opts ...Option) (Apollo, error) {
	a := &apollo{
...
func (a *apollo) initNamespace(namespaces ...string) error {
	var errs []error
...
func (a *apollo) setNotificationIDFromRemote(namespace string, exists bool) {
	if !exists {
...
func (a *apollo) Get(key string, opts ...GetOption) string {
...
func (a *apollo) GetNameSpace(namespace string) Configurations {
...
func (a *apollo) Options() Options {
	return a.opts
}

// 启动goroutine去轮训apollo通知接口
func (a *apollo) Start() <-chan *LongPollerError {
	a.runOnce.Do(func() {
		go func() {
...
func (a *apollo) Watch() <-chan *ApolloResponse {
	if a.watchCh == nil {
...
func (a *apollo) WatchNamespace(namespace string, stop chan bool) <-chan *ApolloResponse {
...
func (a *apollo) sendWatchCh(namespace string, oldVal, newVal Configurations) {
...
func (a *apollo) getWatchChs(namespace string) []chan *ApolloResponse {
...
func (a *apollo) sendErrorsCh(configServerURL string, notifications []Notification, namespace string, err error) {
...
func (a *apollo) log(kvs ...interface{}) {
	a.opts.Logger.Log(
		append([]interface{}{
			"[Apollo]", "",
			"AppID", a.opts.AppID,
...
func (a *apollo) backup(namespace string, config Configurations) error {
...
func (a *apollo) loadBackup() (map[string]Configurations, error) {
	a.backupLock.RLock()
...
func (a *apollo) loadBackupByNamespace(namespace string) (Configurations, error) {
	backup, err := a.loadBackup()
	if err != nil {
		return nil, err
	}
...
func Init(configServerURL, appID string, opts ...Option) (err error) {
	defaultApollo, err = New(configServerURL, appID, opts...)
	return
}

func InitWithConfigFile(configFilePath string, opts ...Option) (err error) {
	defaultApollo, err = NewWithConfigFile(configFilePath, opts...)
	return
}
...
func Get(key string, opts ...GetOption) string {
	return defaultApollo.Get(key, opts...)
}

func GetNameSpace(namespace string) Configurations {
	return defaultApollo.GetNameSpace(namespace)
}

func Watch() <-chan *ApolloResponse {
	return defaultApollo.Watch()
}

func WatchNamespace(namespace string, stop chan bool) <-chan *ApolloResponse {
	return defaultApollo.WatchNamespace(namespace, stop)
}

func GetApollo() Apollo {
	return defaultApollo
}
